...
const translations = {
  en: {
    ...
    "form": { 
      ...
      "addressFoundSuccess": "Address found successfully.",
      "cityFoundSuccess": "City '{city}' found and selected.",
  ...
  fr: {
    ...
    "form": { 
      ...
      "addressFoundSuccess": "Adresse trouvée avec succès.",
      "cityFoundSuccess": "La ville '{city}' a été trouvée et sélectionnée.",
  ...
  ar: {
    ...
    "form": { 
      ...
      "addressFoundSuccess": "تم العثور على العنوان بنجاح.",
      "cityFoundSuccess": "تم العثور على مدينة '{city}' وتحديدها.",
